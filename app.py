...
with tab4:
    ...
    with col1:
        ...
        trading_direction = st.radio(
            ...
            help="""
            **Long**: Buy when entropy is low (contrarian - your current signal)
            **Short**: Sell/short when entropy is low (traditional risk-off)
            """
        )
    ...
    if 'opt_results' in st.session_state:
        ...
        if opt_method == "Grid Search":
            ...
            top_10['corr_weight'] = top_10['corr_weight'].apply(lambda x: f"{x:.1%}")
            ...
            col3.metric("Corr Weight", f"{best['corr_weight']:.1%}")
